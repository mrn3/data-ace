...
import fs from 'fs';
import DataAceView from './views/data-ace-view';
...
/*
  ...
  - A single DataAceView is used, shown or hidden based on the state of a editor
...
export default class DataAceController {
  constructor(serializeState, statusBarManager) {
    ...
    atom.commands.add('atom-workspace', 'data-ace:toggle-query-source', () => this.toggleQuerySource());
