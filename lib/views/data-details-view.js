...
import DataDetailsHeaderView from './data-details-header-view'
...
export default class DataDetailsView {
  ...
  createView() {
    ...
    this.dataDetailsHeaderView = new DataDetailsHeaderView(false)
    this.element.appendChild(this.dataDetailsHeaderView.element)
