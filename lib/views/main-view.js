...
import MainResultsView from './main-results-view'
import MainResultsHeaderView from './main-results-header-view'
...
export default class MainView {
  ...
  createView() {
    ...
    this.headerView = new MainResultsHeaderView(false)
    ...
    this.resultsView = new MainResultsView()
