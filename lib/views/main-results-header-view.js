...
export default class MainResultsHeaderView {
  ...
  render() {
    return (<header className='header toolbar'>
      <button className='btn btn-default btn-query-execute' disabled={this.state.isExecuting} ref='executeBtn'>Execute</button>
      ...
      <select className='limit-select' ref='limit'>
